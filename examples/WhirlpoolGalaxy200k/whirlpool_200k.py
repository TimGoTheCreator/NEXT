...
# =============================================================================
# M51 Whirlpool Galaxy - 200,000 Particle High-Resolution Benchmark
# =============================================================================
TOTAL_N = 200000

# 1. Primary M51 Giant Spiral (160,000 particles)
N_DISK  = 80000   # 80,000 luminous disk stars
N_BULGE = 16000   # 16,000 central bulge stars
N_HALO  = 64000   # 64,000 dark matter halo particles
MASS_MAIN = 5.2

# 2. Companion Dwarf Galaxy NGC 5195 (40,000 particles)
N_COMPANION = 40000
MASS_COMP = 1.7

print("=" * 75)
print("  NEXT - Generating M51 Whirlpool 200,000 Particles Benchmark")
print("===========================================================================")
...
m51_200k = ns.EquilibriumSpiralGalaxy(
    N_disk=N_DISK,
    N_bulge=N_BULGE,
    N_halo=N_HALO,
    R_d=4.0,
...
companion_200k.translate(dx=X_0, dy=Y_0, dz=Z_0)
companion_200k.boost(vx=VX_0, vy=VY_0, vz=VZ_0)

# Merge systems
whirlpool_200k = m51_200k + companion_200k

# Save Initial Conditions
whirlpool_200k.save("whirlpool_200k.txt")
print("\n[SUCCESS] Generated whirlpool_200k.txt (200,000 particles)!")
